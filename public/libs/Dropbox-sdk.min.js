!(function (e, t) {
  ...
  function h(e) {
    return "https://".concat(e, ".dropboxapi.com/2/");
  }
  function m(e) {
    return JSON.stringify(e).replace(/[\u007f-\uffff]/g, f);
  }
  function d(e) {
  ...
  (l.accountSetProfilePhoto = function (e) {
    ...
    (l.contactsDeleteManualContactsBatch = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesAdd = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesOverwrite = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesRemove = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesSearch = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesSearchContinue = function (e) {
      return this.request(
    ...
    (l.filePropertiesPropertiesUpdate = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesAddForTeam = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesAddForUser = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesGetForTeam = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesGetForUser = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesListForTeam = function () {
      return this.request(
    ...
    (l.filePropertiesTemplatesListForUser = function () {
      return this.request(
    ...
    (l.filePropertiesTemplatesRemoveForTeam = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesRemoveForUser = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesUpdateForTeam = function (e) {
      return this.request(
    ...
    (l.filePropertiesTemplatesUpdateForUser = function (e) {
      return this.request(
    ...
    (l.filesGetTemporaryLink = function (e) {
      return this.request("files/get_temporary_link", e, "user", "api", "rpc");
    }),
    (l.filesGetTemporaryUploadLink = function (e) {
      return this.request(
    ...
    (l.filesGetThumbnail = function (e) {
      return this.request(
        "files/get_thumbnail",
        e,
        "user",
    ...
    (l.filesGetThumbnailV2 = function (e) {
      return this.request(
    ...
    (l.filesGetThumbnailBatch = function (e) {
      return this.request(
    ...
    (l.filesListFolder = function (e) {
      return this.request("files/list_folder", e, "user", "api", "rpc");
    }),
    (l.filesListFolderContinue = function (e) {
      return this.request(
    ...
    (l.filesListFolderGetLatestCursor = function (e) {
      return this.request(
    ...
    (l.filesListFolderLongpoll = function (e) {
      return this.request(
    ...
    (l.filesPropertiesRemove = function (e) {
      return this.request("files/properties/remove", e, "user", "api", "rpc");
    }),
    (l.filesPropertiesTemplateGet = function (e) {
      return this.request(
    ...
    (l.filesPropertiesTemplateList = function () {
      return this.request(
    ...
    (l.filesUploadSessionAppend = function (e) {
      return this.request(
    ...
    (l.filesUploadSessionFinish = function (e) {
      return this.request(
    ...
    (l.filesUploadSessionFinishBatch = function (e) {
      return this.request(
    ...
    (l.filesUploadSessionFinishBatchCheck = function (e) {
      return this.request(
    ...
    (l.filesUploadSessionStart = function (e) {
      return this.request(
    ...
    (l.paperDocsFolderUsersListContinue = function (e) {
      return this.request(
    ...
    (l.paperDocsGetFolderInfo = function (e) {
      return this.request(
    ...
    (l.paperDocsSharingPolicyGet = function (e) {
      return this.request(
    ...
    (l.paperDocsSharingPolicySet = function (e) {
      return this.request(
    ...
    (l.sharingCheckJobStatus = function (e) {
      return this.request("sharing/check_job_status", e, "user", "api", "rpc");
    }),
    (l.sharingCheckRemoveMemberJobStatus = function (e) {
      return this.request(
    ...
    (l.sharingCheckShareJobStatus = function (e) {
      return this.request(
    ...
    (l.sharingCreateSharedLink = function (e) {
      return this.request(
    ...
    (l.sharingCreateSharedLinkWithSettings = function (e) {
      return this.request(
    ...
    (l.sharingGetFileMetadata = function (e) {
      return this.request("sharing/get_file_metadata", e, "user", "api", "rpc");
    }),
    (l.sharingGetFileMetadataBatch = function (e) {
      return this.request(
    ...
    (l.sharingGetFolderMetadata = function (e) {
      return this.request(
    ...
    (l.sharingGetSharedLinkFile = function (e) {
      return this.request(
    ...
    (l.sharingGetSharedLinkMetadata = function (e) {
      return this.request(
    ...
    (l.sharingListFileMembersContinue = function (e) {
      return this.request(
    ...
    (l.sharingListFolderMembers = function (e) {
      return this.request(
    ...
    (l.sharingListFolderMembersContinue = function (e) {
      return this.request(
    ...
    (l.sharingListFolders = function (e) {
      return this.request("sharing/list_folders", e, "user", "api", "rpc");
    }),
    (l.sharingListFoldersContinue = function (e) {
      return this.request(
    ...
    (l.sharingListMountableFolders = function (e) {
      return this.request(
    ...
    (l.sharingListMountableFoldersContinue = function (e) {
      return this.request(
    ...
    (l.sharingListReceivedFiles = function (e) {
      return this.request(
    ...
    (l.sharingListReceivedFilesContinue = function (e) {
      return this.request(
    ...
    (l.sharingListSharedLinks = function (e) {
      return this.request("sharing/list_shared_links", e, "user", "api", "rpc");
    }),
    (l.sharingModifySharedLinkSettings = function (e) {
      return this.request(
    ...
    (l.sharingMountFolder = function (e) {
      return this.request("sharing/mount_folder", e, "user", "api", "rpc");
    }),
    (l.sharingRelinquishFileMembership = function (e) {
      return this.request(
    ...
    (l.sharingRelinquishFolderMembership = function (e) {
      return this.request(
    ...
    (l.sharingRemoveFileMember = function (e) {
      return this.request(
    ...
    (l.sharingRemoveFileMember2 = function (e) {
      return this.request(
    ...
    (l.sharingRemoveFolderMember = function (e) {
      return this.request(
    ...
    (l.sharingRevokeSharedLink = function (e) {
      return this.request(
    ...
    (l.sharingSetAccessInheritance = function (e) {
      return this.request(
    ...
    (l.sharingUpdateFolderMember = function (e) {
      return this.request(
    ...
    (l.sharingUpdateFolderPolicy = function (e) {
      return this.request(
    ...
    (l.teamDevicesListMemberDevices = function (e) {
      return this.request(
    ...
    (l.teamDevicesListMembersDevices = function (e) {
      return this.request(
    ...
    (l.teamDevicesListTeamDevices = function (e) {
      return this.request(
    ...
    (l.teamDevicesRevokeDeviceSession = function (e) {
      return this.request(
    ...
    (l.teamDevicesRevokeDeviceSessionBatch = function (e) {
      return this.request(
    ...
    (l.teamGroupsMembersRemove = function (e) {
      return this.request(
    ...
    (l.teamGroupsMembersSetAccessType = function (e) {
      return this.request(
    ...
    (l.teamGroupsUpdate = function (e) {
      return this.request("team/groups/update", e, "team", "api", "rpc");
    }),
    (l.teamLegalHoldsCreatePolicy = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsGetPolicy = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsListHeldRevisions = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsListHeldRevisionsContinue = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsListPolicies = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsReleasePolicy = function (e) {
      return this.request(
    ...
    (l.teamLegalHoldsUpdatePolicy = function (e) {
      return this.request(
    ...
    (l.teamLinkedAppsListMemberLinkedApps = function (e) {
      return this.request(
    ...
    (l.teamLinkedAppsListMembersLinkedApps = function (e) {
      return this.request(
    ...
    (l.teamLinkedAppsListTeamLinkedApps = function (e) {
      return this.request(
    ...
    (l.teamLinkedAppsRevokeLinkedApp = function (e) {
      return this.request(
    ...
    (l.teamLinkedAppsRevokeLinkedAppBatch = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsExcludedUsersAdd = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsExcludedUsersList = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsExcludedUsersListContinue = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsExcludedUsersRemove = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsGetCustomQuota = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsRemoveCustomQuota = function (e) {
      return this.request(
    ...
    (l.teamMemberSpaceLimitsSetCustomQuota = function (e) {
      return this.request(
    ...
    (l.teamMembersAdd = function (e) {
      return this.request("team/members/add", e, "team", "api", "rpc");
    }),
    (l.teamMembersAddJobStatusGet = function (e) {
      return this.request(
    ...
    (l.teamMembersDeleteProfilePhoto = function (e) {
      return this.request(
    ...
    (l.teamMembersMoveFormerMemberFiles = function (e) {
      return this.request(
    ...
    (l.teamMembersMoveFormerMemberFilesJobStatusCheck = function (e) {
      return this.request(
    ...
    (l.teamMembersSecondaryEmailsAdd = function (e) {
      return this.request(
    ...
    (l.teamMembersSecondaryEmailsDelete = function (e) {
      return this.request(
    ...
    (l.teamMembersSecondaryEmailsResendVerificationEmails = function (e) {
      return this.request(
    ...
    (l.teamMembersSendWelcomeEmail = function (e) {
      return this.request(
    ...
    (l.teamMembersSetAdminPermissions = function (e) {
      return this.request(
    ...
    (l.teamMembersSetProfile = function (e) {
      return this.request("team/members/set_profile", e, "team", "api", "rpc");
    }),
    (l.teamMembersSetProfilePhoto = function (e) {
      return this.request(
    ...
    (l.teamPropertiesTemplateAdd = function (e) {
      return this.request(
    ...
    (l.teamPropertiesTemplateGet = function (e) {
      return this.request(
    ...
    (l.teamPropertiesTemplateList = function () {
      return this.request(
    ...
    (l.teamPropertiesTemplateUpdate = function (e) {
      return this.request(
    ...
    (l.teamTeamFolderPermanentlyDelete = function (e) {
      return this.request(
    ...
    (l.teamTeamFolderRename = function (e) {
      return this.request("team/team_folder/rename", e, "team", "api", "rpc");
    }),
    (l.teamTeamFolderUpdateSyncSettings = function (e) {
      return this.request(
    ...
    (l.teamTokenGetAuthenticatedAdmin = function () {
      return this.request(
    ...
    (l.teamLogGetEvents = function (e) {
      return this.request("team_log/get_events", e, "team", "api", "rpc");
    }),
    (l.teamLogGetEventsContinue = function (e) {
      return this.request(
  ...
  var b,
    ...
    y = (function (e) {
      ...
      function o(e, r, s) {
        ...
        return (
          ...
          ((i = a.call(
            this,
            "Response failed with a ".concat(e, " code")
    ...
    A = function e(r, s, i) {
      t(this, e), (this.status = r), (this.headers = s), (this.result = i);
    };
  function w(e) {
    return e.text().then(function (t) {
      ...
      throw new y(e.status, e.headers, r);
    });
  }
  function T(e) {
    return e.ok
      ? e.text().then(function (t) {
          ...
          return new A(e.status, e.headers, r);
        })
      : w(e);
  }
  (b = q() ? window.fetch.bind(window) : require("node-fetch")),
    (v = q() ? window.crypto || window.msCrypto : require("crypto")),
    (k =
      "undefined" == typeof TextEncoder
        ? require("util").TextEncoder
        : TextEncoder);
  var S,
    C = ["legacy", "offline", "online"],
    L = ["code", "token"],
    F = ["none", "user", "team"],
    M = "https://www.dropbox.com/oauth2/authorize",
    P = "https://api.dropboxapi.com/oauth2/token",
    R = (function () {
      function e(r) {
        t(this, e),
          (this.fetch = (r = r || {}).fetch || b),
          (this.accessToken = r.accessToken),
          (this.accessTokenExpiresAt = r.accessTokenExpiresAt),
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function () {
              var e,
                t = this;
              if (q()) {
                var r = new Uint8Array(128),
                  s = v.getRandomValues(r);
                e = g(btoa(s)).substr(0, 128);
              } else {
                e = g(v.randomBytes(128)).substr(0, 128);
              }
              this.codeVerifier = e;
              var i,
                n = new k().encode(e);
              if (q())
                return v.subtle.digest("SHA-256", n).then(function (e) {
                  var r = new Uint8Array(e),
                    s = btoa(r);
                  (i = g(s).substr(0, 128)), (t.codeChallenge = i);
                });
              var u = v.createHash("sha256").update(n).digest();
              return (i = g(u)), (this.codeChallenge = i), Promise.resolve();
            },
          },
          {
            ...
            value: function (e, t) {
              ...
              return (
                (r =
                  "code" === i
                    ? "".concat(p, "?response_type=code&client_id=").concat(c)
                    : ""
                        .concat(p, "?response_type=token&client_id=")
                        .concat(c)),
                e && (r += "&redirect_uri=".concat(e)),
                t && (r += "&state=".concat(t)),
                n && (r += "&token_access_type=".concat(n)),
                u && (r += "&scope=".concat(u.join(" "))),
                "none" !== a && (r += "&include_granted_scopes=".concat(a)),
                o
                  ? this.generatePKCECodes().then(function () {
                      return (
                        (r += "&code_challenge_method=S256"),
                        (r += "&code_challenge=".concat(s.codeChallenge))
                      );
                    })
                  : Promise.resolve(r)
              );
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                (i += "&code=".concat(t)),
                (i += "&client_id=".concat(r)),
                s)
              )
                i += "&client_secret=".concat(s);
              else {
            ...
            value: function () {
              var e = this.getRefreshToken() && this.getClientId(),
                t =
                  ...
                  new Date(Date.now() + 3e5) >= this.getAccessTokenExpiresAt(),
          ...
          },
          {
            ...
            value: function () {
              ...
              (r += "?grant_type=refresh_token&refresh_token=".concat(
                this.getRefreshToken()
              )),
                (r += "&client_id=".concat(s)),
                i && (r += "&client_secret=".concat(i)),
                t && (r += "&scope=".concat(t.join(" ")));
              var u = { method: "POST" };
              return (
                (u.headers = n),
                this.fetch(r, u)
                  ...
                  .then(function (t) {
                    e.setAccessToken(t.result.access_token),
                      e.setAccessTokenExpiresAt(d(t.result.expires_in));
                  })
              );
            },
          },
              ...
              this.getAuthenticationUrl(
                ...
                function u(r) {
                  if (r.url.indexOf("&error=") > -1)
                    ...
                    var s = "#access_token=",
                      n = r.url.indexOf(s),
                      u = r.url.indexOf("&token_type=");
                    if (n > -1) {
                      (n += 14),
                        window.setTimeout(function () {
                          i.close();
                        }, 10);
                      var a = r.url.substring(n, u);
                      e(a);
                    }
                  }
                }
                i.addEventListener("loaderror", n),
                  i.addEventListener("loadstop", u),
                  i.addEventListener("exit", function e() {
                    s ||
                      (i.removeEventListener("loaderror", n),
                      i.removeEventListener("loadstop", u),
                      i.removeEventListener("exit", e),
                      (s = !0));
                  });
              });
            },
  ...
  (e.Dropbox = (function () {
    function e(r) {
      t(this, e),
        (this.auth = (r = r || {}).auth ? r.auth : new R(r)),
        (this.fetch = r.fetch || S),
        (this.selectUser = r.selectUser),
        (this.selectAdmin = r.selectAdmin),
        (this.pathRoot = r.pathRoot),
    ...
    return (
      s(e, [
          ...
          value: function (e, t, r, s) {
            ...
            return this.auth
              ...
              .then(function () {
                ...
                switch (
                  (t && (s.headers["Content-Type"] = "application/json"), r)
                ) {
                  case "app":
                    if (!i.auth.clientId || !i.auth.clientSecret)
                      throw Error(
                        "A client id and secret is required for this function"
                      );
                    (e = G(
                      ""
                        .concat(i.auth.clientId, ":")
                        .concat(i.auth.clientSecret)
                    )),
                      (s.headers.Authorization = "Basic ".concat(e));
                    break;
                  case "team":
                  case p:
                    s.headers.Authorization = "Bearer ".concat(
                      i.auth.getAccessToken()
                    );
                    break;
                  case "noauth":
                    break;
                  default:
                    throw Error("Unhandled auth type: ".concat(r));
                }
                return i.setCommonHeaders(s), s;
              })
              .then(function (t) {
                return i.fetch(h(s) + e, t);
              })
              .then(function (e) {
                return T(e);
              });
        ...
        },
        {
          ...
          value: function (e, t, r, s) {
            ...
            return this.auth
              .checkAndRefreshAccessToken()
              .then(function () {
                if (r !== p) throw Error("Unexpected auth type: ".concat(r));
                var e = {
                  method: "POST",
                  headers: {
                    Authorization: "Bearer ".concat(i.auth.getAccessToken()),
                    "Dropbox-API-Arg": m(t),
                  },
                };
                return i.setCommonHeaders(e), e;
              })
              .then(function (t) {
                return S(h(s) + e, t);
              })
                ...
                return (function (e) {
                  return e.ok
                    ? new Promise(function (t) {
                        ...
                        return (
                          _() ? (r.fileBlob = t) : (r.fileBinary = t),
                          new A(e.status, e.headers, r)
                        );
                      })
                    : w(e);
                })(e);
        ...
        },
        {
          ...
          value: function (e) {
            this.selectUser &&
              (e.headers["Dropbox-API-Select-User"] = this.selectUser),
              this.selectAdmin &&
                (e.headers["Dropbox-API-Select-Admin"] = this.selectAdmin),
              this.pathRoot &&
                (e.headers["Dropbox-API-Path-Root"] = this.pathRoot);
          },
        },
      ]),
      e
